...
export default function SkeletonTable({ rowsPerPage, totalHead }) {
  return (
    <>
                ...
                <div className="table-row-group bg-white">
                  {[...Array(rowsPerPage)].map((_, i) => (
                    <div key={i} className="table-row">
                      <div className="table-cell border-b border-slate-100 pt-7 pb-[21px] pl-8"><Skeleton style="w-32 h-3" /></div>
                      <div className="table-cell border-b border-slate-100 pt-7 pb-[21px] pl-8"><Skeleton style="w-32 h-3" /></div>
                      <div className="table-cell border-b border-slate-100 pt-7 pb-[21px] pl-8"><Skeleton style="w-32 h-3" /></div>
                      <div className="table-cell border-b border-slate-100 pt-7 pb-[21px] pl-8"><Skeleton style="w-32 h-3" /></div>
                      <div className="table-cell border-b border-slate-100 pt-7 pb-[21px] pl-8"><Skeleton style="w-32 h-3" /></div>
